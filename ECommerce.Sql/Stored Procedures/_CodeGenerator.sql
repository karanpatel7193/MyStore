...
EXEC [dbo].[_CodeGenerator]
	@TableName = 'Product', --Actual database table name
	@TableShortName = 'P', --Table short name, if table name is UserRole then short name is UR
	@PKFieldName = 'Id', --Table primary key field name
	@AlreadyExistFields = 'Name SKU', --Already exists check field list by space seperated while insert or update
	@IsTransactionApply = 1,
	@ClsTableName = 'Product', --Class name except word cls and Business, Entity, Controller means if you enter User then Business > clsUserBusiness, Entity > clsUserEntity, model > UserModel etc...
	@AddLOVs = 'Product Category', --Singular table name list by space sperated for page add/edit mode
	@ListLOVs = 'Category', --Singular table name list by space sperated for page list mode
	@MainColumns = 'Id Name SKU', --Main fields list by space seperated for LOV
	@ParameterColumns = 'Id CategoryId Name', --Field list by space seperated for create where part and parameter class
	@Namespace = 'Admin.Product', --Class namespace for generete namespace and routes
...
BEGIN
	...
	DECLARE @Repository_String NVARCHAR(MAX) = ''
	...
	DECLARE @DateDataTypeAdd NVARCHAR(MAX) = ''
	...
	BEGIN
		...
		SELECT @DateDataTypeAdd = CASE @DataType
			WHEN 'date' THEN 'DbType.Date, ParameterDirection.Input, '
			WHEN 'datetime' THEN 'DbType.DateTime, ParameterDirection.Input, '
			else '' end
		...
		BEGIN
			...
			SET @BusinessParameter = @BusinessParameter + 'if(' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity.' + @ColumnName + ' != ' + @NetDefaultValue + ')' + CHAR(13) + 'sql.AddParameter("' + @ColumnName + '", ' + @DateDataTypeAdd + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity.' + @ColumnName + ');' + CHAR(13)
		...
		if(@PKFieldName != @ColumnName)
		begin
			SET @InsertAddParameter = @InsertAddParameter + CASE @IsNullable WHEN 1 THEN 'if(' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity.' + @ColumnName + ' != ' + @NetDefaultValue + ')' + CHAR(13) ELSE '' END + 'sql.AddParameter("' + @ColumnName + '", ' + @DateDataTypeAdd + dbo.fnJavaScriptName(@ClsTableName) + 'Entity.' + @ColumnName + ');' + CHAR(13)
		...
		SET @SelectAddParameter = @SelectAddParameter + 'if(' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity.' + @ColumnName + ' != ' + @NetDefaultValue + ')' + CHAR(13) + 'sql.AddParameter("' + @ColumnName + '", ' + @DateDataTypeAdd + dbo.fnJavaScriptName(@ClsTableName) + 'Entity.' + @ColumnName + ');' + CHAR(13)
	...
	public class '+ @ClsTableName + 'Entity : '+ @ClsTableName + 'MainEntity
{
	...
	SET @Repository_String = N'/// <summary>
	/// This interface having crud operation methods declarations of table '+ @TableName + '
	/// Created By :: '+ @DevelopmentBy + '
	/// Created On :: '+ CONVERT(VARCHAR(10), @DevelopmentDateTime, 101) + '
	/// </summary>
	public interface I'+ @ClsTableName + 'Repository : IBusiness<'+ @ClsTableName + 'Entity, '+ @ClsTableName + 'MainEntity, '+ @ClsTableName + 'AddEntity, '+ @ClsTableName + 'EditEntity, '+ @ClsTableName + 'GridEntity, '+ @ClsTableName + 'ListEntity, '+ @ClsTableName + 'ParameterEntity, ' + @PKNetFieldDataType + '>
{
	...
	/// Created On :: '+ CONVERT(VARCHAR(10), @DevelopmentDateTime, 101) + '
	/// </summary>
	public class '+ @ClsTableName + 'Business : CommonBusiness, I'+ @ClsTableName + 'Repository
{
        ISql sql;
    ...
    /// <returns>Entity</returns>
        public '+ @ClsTableName + 'Entity MapData(IDataReader reader)
        {
        ...
        /// <returns>Entity</returns>
        public async Task<'+ @ClsTableName + 'Entity> SelectForRecord(' + @PKNetFieldDataType + ' ' + dbo.fnJavaScriptName(@PKFieldName) + ')
        {
		...
		public async Task<List<' + @ClsTableName + 'MainEntity>> SelectForLOV(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
		{
            ' + @BusinessParameter + '
        ...
        public async Task<' + @ClsTableName + 'AddEntity> SelectForAdd(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ' + @BusinessParameter + '
            return await sql.ExecuteResultSetAsync<' + @ClsTableName + 'AddEntity>("' + @TableName + '_SelectForAdd", CommandType.StoredProcedure, ' + CONVERT(VARCHAR, @AddLOVsCount) + ', MapAddEntity);
        }
        ...
        public async Task MapAddEntity(int resultSet, ' + @ClsTableName + 'AddEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'AddEntity, IDataReader reader)
        {
            switch(resultSet)
            {
                ' + @MapAddEntity  + '
        ...
        public async Task<' + @ClsTableName + 'EditEntity> SelectForEdit(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ' + @BusinessParameter + '
            return await sql.ExecuteResultSetAsync<' + @ClsTableName + 'EditEntity>("' + @TableName + '_SelectForEdit", CommandType.StoredProcedure, ' + CONVERT(VARCHAR, @AddLOVsCount + 1) + ', MapEditEntity);
        }
        ...
        /// <param name="reader">Database reader</param>
        public async Task MapEditEntity(int resultSet, ' + @ClsTableName + 'EditEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'EditEntity, IDataReader reader)
        {
            switch (resultSet)
            {
                case 0:
        ...
        public async Task<' + @ClsTableName + 'GridEntity> SelectForGrid(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ' + @BusinessParameter + '
            ...
            return await sql.ExecuteResultSetAsync<' + @ClsTableName + 'GridEntity>("' + @TableName + '_SelectForGrid", CommandType.StoredProcedure, 2, MapGridEntity);
        }
        ...
        /// <param name="reader">Database reader</param>
        public async Task MapGridEntity(int resultSet, ' + @ClsTableName + 'GridEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'GridEntity, IDataReader reader)
        {
            switch (resultSet)
            {
                case 0:
        ...
        public async Task<' + @ClsTableName + 'ListEntity> SelectForList(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ' + @BusinessParameter + '
            sql.AddParameter("SortExpression", ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity.SortExpression);
            sql.AddParameter("SortDirection", ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity.SortDirection);
            sql.AddParameter("PageIndex", ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity.PageIndex);
            sql.AddParameter("PageSize", ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity.PageSize);
            return await sql.ExecuteResultSetAsync<' + @ClsTableName + 'ListEntity>("' + @TableName + '_SelectForList", CommandType.StoredProcedure, ' + CONVERT(VARCHAR, @ListLOVsCount + 2) + ', MapListEntity);
        }
        ...
        /// <param name="reader">Database reader</param>
        public async Task MapListEntity(int resultSet, ' + @ClsTableName + 'ListEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ListEntity, IDataReader reader)
        {
            switch (resultSet)
            {
                ' + @MapListEntity + '
		...
		public async Task<' + @PKNetFieldDataType + '> Insert(' + @ClsTableName + 'Entity ' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity)
		{
		...
		public async Task<' + @PKNetFieldDataType + '> Update(' + @ClsTableName + 'Entity ' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity)
		{
		...
		/// </summary>
		public async Task Delete(' + @PKNetFieldDataType + ' ' + dbo.fnJavaScriptName(@PKFieldName) + ')
		{
			sql.AddParameter("' + @PKFieldName + '", ' + dbo.fnJavaScriptName(@PKFieldName) + ');
    ...
    {
        //services.AddScoped<I' + @ClsTableName + 'Repository, ' + @ClsTableName + 'Business>();  //Move this line in Startup.cs file
        I' + @ClsTableName + 'Repository ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository;
		public ' + @ClsTableName + 'Controller(I' + @ClsTableName + 'Repository ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository)
		{
			this.' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository = ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository;
		}
        ...
        public async Task<Response> GetForRecord(' + @PKNetFieldDataType +' ' + dbo.fnJavaScriptName(@PKFieldName) + ')
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.SelectForRecord(' + dbo.fnJavaScriptName(@PKFieldName) + '));
            }
            catch (Exception ex)
            {
        ...
        [AuthorizeAPI(pageName : "' + @ClsTableName + '", pageAccess : PageAccessValues.IgnoreAuthorization)]
        public async Task<Response> GetForLOV(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            Response response;
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.SelectForLOV(' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> GetForAdd(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.SelectForAdd(' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> GetForEdit(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.SelectForEdit(' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> GetForGrid(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.SelectForGrid(' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> GetForList(' + @ClsTableName + 'ParameterEntity ' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity)
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.SelectForList(' + dbo.fnJavaScriptName(@ClsTableName) + 'ParameterEntity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> Insert(' + @ClsTableName + 'Entity ' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity)
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.Insert(' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> Update(' + @ClsTableName + 'Entity ' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity)
        {
            ...
            try
            {
                response = new Response(await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.Update(' + dbo.fnJavaScriptName(@ClsTableName) + 'Entity));
            }
            catch (Exception ex)
            {
				response = new Response(await ex.WriteLogFileAsync(), ex);
        ...
        public async Task<Response> Delete(' + @PKNetFieldDataType +' ' + dbo.fnJavaScriptName(@PKFieldName) + ')
        {
            ...
            try
            {
                await ' + dbo.fnJavaScriptName(@ClsTableName) + 'Repository.Delete(' + dbo.fnJavaScriptName(@PKFieldName) + ');
...
'
    ...
    SELECT 'I' + @TableName + 'Repository.cs' [Repository Interface File Name]
	SELECT @Repository_String AS Repository
	...
	--SELECT @AngularModelString AS [AngularJs Model]
	--SELECT @AngularServiceString AS [AngularJs Service]
	--SELECT @AngularRouteString AS [AngularJs Route]
	--SELECT @AngularAddEditControllerString AS [AngularJs Add-Edit Controller]
	--SELECT @AngularListControllerString AS [AngularJs List Controller]
	--SELECT @AddEditHtmlString AS [AngularJs Add Edit HTML]
	--SELECT @ListHtmlString AS [AngularJs List HTML]

    SELECT LOWER(@TableName) + '.module.ts' [Angular Module File Name]
	SELECT @Angular2ModuleString AS [Angular Module]
    SELECT LOWER(@TableName) + '.model.ts' [Angular Model File Name]
	SELECT @Angular2ModelString AS [Angular Model]
    SELECT LOWER(@TableName) + '.service.ts' [Angular service File Name]
	SELECT @Angular2ServiceString AS [Angular Service]
    SELECT LOWER(@TableName) + '.route.ts' [Angular Route File Name]
	SELECT @Angular2RouteString AS [Angular Route]
    SELECT LOWER(@TableName) + '.component.ts' [Angular Component File Name]
	SELECT @Angular2ComponentString AS [Angular Component]
    SELECT LOWER(@TableName) + '-form.component.html' [Angular Form Component HTML File Name]
	SELECT @Angular2FormHTMLString AS [Angular Form HTML]
    SELECT LOWER(@TableName) + '-form.component.ts' [Angular Form Component TS File Name]
	SELECT @Angular2FormComponentString AS [Angular Form Component]
    SELECT LOWER(@TableName) + '-list.component.html' [Angular List Component HTML File Name]
	SELECT @Angular2ListHTMLString AS [Angular List HTML]
    SELECT LOWER(@TableName) + '-list.component.ts' [Angular List Component TS File Name]
	SELECT @Angular2ListComponentString AS [Angular List Component]
END