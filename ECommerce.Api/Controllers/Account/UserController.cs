...
namespace ECommerce.Api.Controllers.Master
{
    /// <summary>
    ...
    public class UserController : ControllerBase, IPageController<UserEntity, UserParameterEntity, long>
    {
        ...
        public async Task<Response> Registration(UserEntity userEntity)
        {
            ...
            try
            {
                ...
                if (id > 0)
                {
                    try
                    {
                        ECommerce.Api.Common.Emails emails = new Emails(Startup.Configuration, _hostingEnvironment);
