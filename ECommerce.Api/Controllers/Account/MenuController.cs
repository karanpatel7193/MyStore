...
namespace ECommerce.Api.Controllers.Account
{
    [Route("account/menu")]
    [ApiController]
    public class MenuController : ControllerBase, IPageController<MenuEntity, MenuParameterEntity, int>
    {
        ...
        [HttpPost]
        [Route("getListData", Name = "account.menu.getListData")]
        [AuthorizeAPI(pageName: "Menu", pageAccess: PageAccessValues.Delete)]

        public Task<Response> GetForList(MenuParameterEntity objParameter)
        {
            throw new NotImplementedException();
        }

        [HttpPost]
        [Route("getLOVData", Name = "account.menu.getLOVData")]
        [AuthorizeAPI(pageName: "Menu", pageAccess: PageAccessValues.Delete)]
        public Task<Response> GetForLOV(MenuParameterEntity objParameter)
        {
            throw new NotImplementedException();
        }
        #endregion
