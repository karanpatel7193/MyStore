...
namespace ECommerce.Business.Account
{
    ...
    public class MenuBusiness : CommonBusiness, IMenuRepository
    {
        ...
        public Task<MenuListEntity> SelectForList(MenuParameterEntity objParameter)
        {
            throw new NotImplementedException();
        }

        public Task MapListEntity(int resultSet, MenuListEntity objListEntity, IDataReader reader)
        {
            throw new NotImplementedException();
        }

        public Task<List<MenuMainEntity>> SelectForLOV(MenuParameterEntity objParameter)
        {
            throw new NotImplementedException();
        }
        #endregion
        ...
        public Task MapGridEAL(int resultSet, MenuGridEntity objGridEntity, IDataReader reader)
        {
            throw new NotImplementedException();
        }
