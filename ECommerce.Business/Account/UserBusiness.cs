...
namespace ECommerce.Business.Master
{
    ...
    public class UserBusiness : CommonBusiness, IUserReppository, IBusiness<UserEntity, UserMainEntity, UserAddEntity, UserEditEntity, UserGridEntity, UserListEntity, UserParameterEntity, long>
    {
        ISql sql;
